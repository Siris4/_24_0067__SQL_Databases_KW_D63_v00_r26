                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url_for('delete_book', book_id=book.id) }}" 
                                   ...
                                   style="color:purple;text-decoration:underline;cursor:pointer;">Delete Book</a>
                                <form id="delete-form-{{ book.id }}" action="{{ url_for('delete_book', book_id=book.id) }}" method="post" style="display:none;">
                                    <button type="submit">Delete Book</button>
                                </form>
                                &nbsp;&nbsp;&nbsp;
                                <a href="{{ url_for('edit_form', book_id=book.id) }}">Edit Rating</a>
                            </td>
                        </tr>
                    {% endfor %}
                </tbody>
